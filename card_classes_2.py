...
class BJ_Game(object):
    ...
    def play(self):
        ...
        #if there are not enough cards for all players to have 7 cards then repopulate and shuffle the deck. 
        if len(self.players) * 7 > len(self.deck.cards):
            print "\nRepopular and shuffle the deck"
            self.deck.populate()
            self.deck.shuffle()
